    ...
    <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-2">
            <figure className="flex items-center gap-1">
                <img 
                src={`/assets/icons/${isDecrement ? 'arrow-down-red' : 'arrow-up-green.svg'}`} className="size-5" alt="arrow" />

                <figcaption className="{cn('text-sm font-medium', 'isDecrement ? 'text-red-500' : 'texy-green-500')}">{Math.round(percentage)}%</figcaption>
